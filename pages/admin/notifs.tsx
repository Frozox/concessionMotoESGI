        ...
        <Fragment>
            ...
            <LayoutAdmin>
                <form onSubmit={handleFormSubmit} className="flex w-full justify-center">
                    ...
                    <div className="w-3/4 flex flex-col items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                        ...
                        <div className="mx-4 p-2.5 w-full space-y-2 flex flex-col justify-center items-center">
